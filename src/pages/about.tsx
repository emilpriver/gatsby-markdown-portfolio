      ...
      <Layout>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="mb-12 md:mb-0">
            <HeaderBigText>Hi I'm Emil Privér. Software developer from Varberg, Sweden</HeaderBigText>
            <BigParagraph>My works is mainly focused on backend and architecture. But also intersted in AI. Most of the stuffs I do at the moment is for e-commerce as that is most what I do for work.</BigParagraph>
            <BigParagraph>
