      ...
      <Layout>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="mb-12 md:mb-0">
            <h1 className="text-4xl md:text-6xl mb-12 font-medium">Hi I'm Emil Privér. Software developer from Varberg, Sweden</h1>
            <p className="text-2xl md:text-3xl text-gray-500 mb-12">My works is mainly focused on backend and architecture. But also intersted in AI. Most of the stuffs I do at the moment is for e-commerce as that is most what I do for work.</p>
