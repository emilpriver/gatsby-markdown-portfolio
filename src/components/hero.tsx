  ...
  return (
      <>
        ...
        <a href="https://twitter.com/emil_priver" target="_blank" rel="nofollow noopener noreferrer"
           className="hover:scale-105 transition-all bg-twitter-blue col-span-1 flex items-center justify-center rounded-3xl">
        ...
        <a href="https://github.com/emilpriver" target="_blank" rel="nofollow noopener noreferrer"
           className="hover:scale-105 transition-all bg-black col-span-1 flex items-center justify-center rounded-3xl">
