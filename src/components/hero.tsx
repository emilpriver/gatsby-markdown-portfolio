    ...
    return (
        <>
            <div className="rounded-3xl p-6 bg-white block float-left col-span-2">
                ...
                <h3 className="mt-2 text-hero-dark antialiased font-medium text-xl">Hi, im Emil Privér. Software
                    developer with a focus backend, love tech, serverless, distributed systems, and trying new
                    stuff.</h3>
            </div>
            <div className="col-span-1">
                <a
                    href="https://twitter.com/emil_priver" target="_blank" rel="nofollow noopener noreferrer"
                    ...
                    aria-label="Emil Priver twitter"
                >
